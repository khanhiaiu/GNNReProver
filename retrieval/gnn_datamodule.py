...
def gnn_collate_fn(
    ...
    negative_mining_strategy: Optional[str] = None,
) -> Batch:
    batch = {}
    ...
    if is_train:
        assert num_negatives is not None and negative_mining_strategy is not None
        ...
        # For prediction/validation, pass through all extra data for evaluation.
