...
# 4. Visualizes the impact of the GNN on premise embeddings using MDS.
#
...
VISUALIZATION_DIR="${LOG_DIR}/visualizations"
...
echo
echo "--- STEP 2 of 4: RUNNING DYNAMIC PREDICTION ---"
...
echo
echo "--- STEP 3 of 4: EVALUATING PREDICTIONS ---"
...
echo
echo "--- STEP 4 of 4: GENERATING EMBEDDING VISUALIZATION ---"
echo "Visualizations will be saved to: $VISUALIZATION_DIR"

## --- FIXED: Added the --data-path argument ---
#python retrieval/visualize_gnn_embeddings.py \
#    --gnn-config "$SAVED_CONFIG_PATH" \
#    --gnn-ckpt-path "$GNN_CHECKPOINT_PATH" \
#    --retriever-ckpt-path "$BASE_RETRIEVER" \
#    --data-path "$DATA_PATH" \
